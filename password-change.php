...
<div class="login-reg-panel">
    ...
    <input type="submit" value="Get Back" />
      ...
      <div class="white-panel">
        ...
        <form  action="passback.php" method="POST">
        <h2>PASSWORD CHANGING</h2>
        <h4>Email</h4>
        <input type="hidden" name="tokenPassword" value="<?php if(isset($_GET['token'])){echo $_GET['token'];}?>">
        <input type="text" name="email-pass" class="form-control" value="<?php if(isset($_GET['email'])){echo $_GET['email'];}?>">
        <h4>New password</h4>
        ...
        <input type="text" name="confirmPassword" class="form-control">
          ...
          <input name="updatePassword" type="submit" value="Confirm"></br>
        </form>
